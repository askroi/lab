...
int main() {
    ...
    printf("¬ведите размер 1 множества: ");
    scanf_s("%d", &size1);
    getchar();
    inArr(mass1, size1, &rS1);
    printf("\n");
    printf("¬ведите размер 2 множества: ");
    scanf_s("%d", &size2);
    getchar();
    inArr(mass2, size2, &rS2);
    printf("\n");
    printf("ѕроверка на уникальность 1 множества: \n");
    printArray(mass1, rS1);
    printf("\n");
    rnotun(mass1, &rS1);
    printf("ѕроверка на уникальность 2 множества \n");
    printArray(mass2, rS2);
    printf("\n");
    rnotun(mass2, &rS2);
    printf("Ёлементы 1 множества: \n");
    printArray(mass1, rS1);
    printf("\n");
    printf("Ёлементы 2 множества: \n");
    printArray(mass2, rS2);
    printf("\n");
    unArr(mass_uniq, &rS, mass1, rS1, mass2, rS2);
    printf("Ёлементы при объединении: \n");
    printArray(mass_uniq, rS);
    printf("\n");
    interArr(mass_inter, &iS, mass1, rS1, mass2, rS2);
    printf("Ёлементы при пересечении: \n");
    ...
    printf("—имметрическа€ разность A и B: \n");
